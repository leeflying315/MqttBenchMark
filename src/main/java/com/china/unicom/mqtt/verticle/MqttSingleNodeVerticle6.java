...
@Log4j2
public class MqttSingleNodeVerticle6 extends AbstractVerticle {
        ...
        client.connect(1883, PRODCUT_Server_Ip, s -> {
            if (s.succeeded()) {
                ...
                vertx.setPeriodic(1000*60, stopHandler -> {
                    String body = PropertiesPubBean.getPropertiesPub6();

                    client.publish("$sys/cu4mut8wrbmhmoxJ/sOJUMeVFsAL7fYP/property/batch", Buffer.buffer(body),
    ...
    public MqttClientOptions initClientConfig() {
        String productKey = "cu4mut8wrbmhmoxJ";
        String deviceKey = "sOJUMeVFsAL7fYP";
        String deviceSecret = "EB14A6B2A5A0FD18914135DBCD0DE51B";
        String deviceId = "sOJUMeVFsAL7fYP";
